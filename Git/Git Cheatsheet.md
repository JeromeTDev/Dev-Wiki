...
git config --global init.defaultBranch main # Globalen Default-Branch dauerhaft ändern
...
# --- Bereits existierendes Repository von `master` auf `main` umstellen ---
git branch -m master main           # Lokalen Branch umbenenen
git push -u origin main             # Neuen Branch pushen
gh repo edit --default-branch main  # GitHub Default-Branch ändern (CLI)
git push origin --delete master     # Alten `master` Branch löschen
```
